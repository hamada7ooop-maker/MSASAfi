...
| M-4 | فحص الجذر بمطابقة نصّ User-Agent | ✅ **مُغلقة بالحذف** — الفحص كان يستحيل أن يعمل، وقيمته المرجعة مُهمَلة أصلاً؛ أُزيل بدل تركه يمنح ثقة زائفة | `__COMMIT__` |
| — | 🔴 تسريب النسخ الاحتياطي المحلي + قفل المستخدم خارج تطبيقه (انحدار من `ae9c97f`) | ✅ **عولجت** | `__COMMIT__` |
