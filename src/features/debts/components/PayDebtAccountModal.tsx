...
interface PayDebtAccountModalProps {
  isOpen: boolean;
  onClose: () => void;
  accounts: Account[];
...
export function PayDebtAccountModal({ isOpen, onClose, accounts, onConfirm }: PayDebtAccountModalProps) {
    ...
    >
      <div 
        ...
        <h3 className="text-lg font-black mb-4 text-slate-800 dark:text-white">
          {t('bill.selectAccountPay') || 'Select Account'}
        </h3>
