# Masarifi Project Status (v23.3.1 — التوجيه 19 + ملحق الأداء، بانتظار توقيعك 🏁)
...
**بانتظارك للتوقيع النهائي**: بناء `@abc` على جهازك لإصدار **v23.3.1** الموقّع (يشمل ملحق الأداء) — ثم يُغلق التوجيه رسمياً.
