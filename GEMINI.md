...
- **التوجيه 17 — الجزء 2 (المفوَّض في `41707e8`): تفعيل Crashlytics الأصلي — النمط الشرطي: الملف هو المفتاح الوحيد (Directive 17 Part 2: Conditional Native Activation — drop the file, everything lights up)**:
  ...
  - **6. المطلوب من المالك (خطوة واحدة)**: تنزيل `google-services.json` من Firebase Console ووضعه في `android/app/` ثم تشغيل `npm run release` — والتأكد من وصول كراش تجريبي إلى Firebase Console.
