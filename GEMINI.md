# Masarifi Project Status (v23.3.2 — التوجيه 19 + الملحقان، بانتظار توقيعك 🏁)
...
**بانتظارك للتوقيع النهائي**: بناء `@abc` على جهازك لإصدار **v23.3.2** الموقّع (يشمل ملحق الأداء + التفكيك) — ثم يُغلق التوجيه رسمياً.
